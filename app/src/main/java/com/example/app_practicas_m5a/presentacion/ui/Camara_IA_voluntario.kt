...
import com.example.app_practicas_m5a.databinding.ActivityCamaraIaBinding
import java.nio.ByteBuffer
import java.util.concurrent.ExecutorService
import java.util.concurrent.Executors

class Camara_IA_voluntario : AppCompatActivity() {

    private lateinit var binding: ActivityCamaraIaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCamaraIaBinding.inflate(layoutInflater)
